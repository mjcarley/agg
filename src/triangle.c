...
*
* Code modified by Michael Carley, 2023. 
*
* All unexported functions are now declared static and a (void) has
* been inserted in prototypes of functions taking no arguments.
* 
* Other modifications are marked in the file by a comment containing
* 
* Modified MJC 2023
*
* The modifications to the code proper are to add a pointer to the
* behavior struct for user data which can be passed to triunsuitable
* when testing for triangle refinement. There are corresponding
* modifications to triunsuitable() and its prototype, to allow passing
* the user data, and to triangulate() to allow passing in the data and
* attaching it to the behavior struct.
*
* 
*
*****************************************************************************/
...
/* Variables for file names.                                                 */
  ...
  /*Modified MJC 2023: user data to pass to triunsuitable*/
  void *user_data ;
...
/*Modified MJC 2023: added data to pass to triangle test*/
static int triunsuitable(vertex triorg, vertex tridest, vertex triapex, REAL area,
		  void *data)
#else /* not ANSI_DECLARATORS */
/*Modified MJC 2023: added data to pass to triangle test*/
static  int triunsuitable(triorg, tridest, triapex, area, data)
...
#ifdef ANSI_DECLARATORS
static VOID *trimalloc(int size)
#else /* not ANSI_DECLARATORS */
...
#else /* not ANSI_DECLARATORS */
static struct badsubseg *badsubsegtraverse(m)
struct mesh *m;
#endif /* not ANSI_DECLARATORS */
...
#else /* not ANSI_DECLARATORS */
static struct badtriang *dequeuebadtriang(m)
struct mesh *m;
#endif /* not ANSI_DECLARATORS */
...

{
  ...
  if (b->vararea || b->fixedarea || b->usertest) {
    ...
    if (b->usertest) {
      ...
      /* Modified MJC 2023: call to triunsuitable includes user data*/
      if (triunsuitable(torg, tdest, tapex, area, b->user_data)) {
        enqueuebadtri(m, b, testtri, minedge, tapex, torg, tdest);
        return;
      }
    }
...
static struct splaynode *splay(struct mesh *m, struct splaynode *splaytree,
                        vertex searchpoint, struct otri *searchtri)
#else /* not ANSI_DECLARATORS */
static struct splaynode *splay(m, splaytree, searchpoint, searchtri)
struct mesh *m;
...
#else /* not ANSI_DECLARATORS */
static struct splaynode *splayinsert(m, splayroot, newkey, searchpoint)
struct mesh *m;
...
#else /* not ANSI_DECLARATORS */
static struct splaynode *circletopinsert(m, b, splayroot, newkey, pa, pb, pc, topy)
struct mesh *m;
struct behavior *b;
struct splaynode *splayroot;
struct otri *newkey;
...
#else /* not ANSI_DECLARATORS */
static struct splaynode *frontlocate(m, splayroot, bottommost, searchvertex,
                              searchtri, farright)
struct mesh *m;
struct splaynode *splayroot;
...

{
  ...
  vertex newvertex;
  enum insertvertexresult success;
  /*Modified MJC 2023: unused variable*/
  ...
  /*Modified MJC 2023: return result is not used*/
...

{
  ...
  "  Splitting subsegment (%.12g, %.12g) (%.12g, %.12g) at (%.12g, %.12g).\n",
	...
	/*Modified MJC 2023: return results not used*/
...
#ifdef ANSI_DECLARATORS
static void writeneighbors(struct mesh *m, struct behavior *b,
			   char *neighborfilename, int argc, char **argv)
#else /* not ANSI_DECLARATORS */
...
#ifdef ANSI_DECLARATORS
/*Modified MJC 2023: added user_data to pass to triunsuitable*/
void triangulate(char *triswitches, struct triangulateio *in,
                 struct triangulateio *out, struct triangulateio *vorout,
		 void *user_data)
#else /* not ANSI_DECLARATORS */
/*Modified MJC 2023: added user_data to pass to triunsuitable*/
  void triangulate(triswitches, in, out, vorout, user_data)
char *triswitches;
...

{
  ...
  /*Modified MJC 2023: add user_data to behavior struct*/
